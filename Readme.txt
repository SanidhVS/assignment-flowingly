...
*	The project comprises of a frontend solution which is being developed in Angular 15.0.0 and 
...
*	For running the server side application, all we need to do is.
	
	*	Open the directory where backend solution is situated.
	*	Double click the solution file named as API.sln.
	*	Make sure to run the solution in IIS Express.	
